...
const (
	...
	NeedTypePanales         NeedType = "pañales"
	NeedTypeAguaSaneamiento NeedType = "agua_saneamiento"
	NeedTypeBanosPortatiles NeedType = "banos_portatiles"

	// Refugio
	NeedTypeAlbergueTemporal   NeedType = "albergue_temporal"
	NeedTypeCarpas             NeedType = "carpas"
	NeedTypeCobijasColchonetas NeedType = "cobijas_colchonetas"
	...
	NeedTypeRopaClimaFrio NeedType = "ropa_clima_frio"
	...
	NeedTypeConectividadInternet NeedType = "conectividad_internet"
	...
	// Herramientas
	NeedTypeHerramientasObra NeedType = "herramientas_obra"
	NeedTypeVoluntariosCampo NeedType = "voluntarios_campo"
	NeedTypeMaquinariaPesada NeedType = "maquinaria_pesada"
...
type CreateTicketRequest struct {
	...
	ResourceCategory string         `json:"resource_category" binding:"required"`
